        ...
        <section className="w-full px-3 sm:px-6 lg:px-8 py-4 sm:py-6 h-full">
            <Card className="w-full bg-neutral-beige-light border-0 shadow-xl rounded-2xl overflow-hidden">
                ...
                <CardContent className="px-2 sm:px-6 lg:px-8 py-4 sm:py-5">
                    <p className="text-xl">
                        To get started with Five Star Souvenirs, create an account by clicking <Link href="/signup" className="text-secondary-dark hover:underline"> Sign Up</Link> in the top right corner.
                       <br></br>
                       <br></br>
                        Once you have created an account please use the <Link href="/contact" className="text-secondary-dark hover:underline">Contact Page</Link> to let us know you have signed up.
                        <br></br>
                        <br></br>
